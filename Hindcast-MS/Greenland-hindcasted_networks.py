...
# 17 Nov 2021: edited for SC to test data imports etc (yay!)
...
import sys
sys.path.insert(0, '/Users/siena/Documents/GitHub/plastic-networks')
...
gl_bed_path = '/Users/siena/Documents/Thesis/sermeq_data/bedmachine/BedMachineGreenland-2021-04-20.nc'
...
gl_smb_path = '/Users/siena/Documents/Thesis/sermeq_data/HIRHAM5_smb/DMI-HIRHAM5_GL2_ERAI_1980_2016_SMB_MM.nc'
...
optimal_taus_fpath = '/Users/siena/Documents/Thesis/sermeq_data/bestfit_taus-B_S_smoothing-fromdate_2019-01-17.csv'
...
base_fpath = '/Users/siena/Documents/Thesis/sermeq_data/Gld-autonetwork-GID'
...
gids_totest = (6,)  # test specific glaciers
network_output = []
bad_gids = []
...
for gid in gids_totest:
    ...
    fn3 = fn2.replace("/", "_")
    fn4 = fn3.replace("]", "")
    fn5 = '/Users/siena/Documents/Thesis/Hindcasted_networks/'+fn4+'-{}-{}-{}ice-{}a_dt025a.pickle'.format(datetime.date.today(), scenario, icetemp, int(max(testyears)))
    nw.save_network(filename=fn5)

    # network_output.append(nw.model_output)

# Output errors to csv file
error_fn = '/Users/siena/Documents/Thesis/Hindcasted_networks/error_gids-{}.csv'.format(datetime.date.today())
